...
const {jump, getJumpCountUntilOutOfRange} = require('./5b')
...
describe('5a', () => {
    describe('#jump', () => {
        ...
        it('when the offset is three or more', () => {
            const state = Immutable.Map({
                offsets: Immutable.List.of(0, 3, 0, 1, -3),
                idx: 1
            })
            const expectedNextState = Immutable.Map({
                offsets: Immutable.List.of(0, 2, 0, 1, -3),
                idx: 4,
                isIndexInRange: true,
                jumps: 1
            })
    ...
    describe('#getJumpCountUntilOutOfRange', () => {
        it('example 1', () => {
            ...
            expect(getJumpCountUntilOutOfRange(offsets)).to.equal(10)
        })
    })
})